# Generated by Django 2.1 on 2018-08-31 04:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=32, null=True, verbose_name='icon Code')),
                ('priority', models.IntegerField(unique=True, verbose_name='优先级')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.SmallIntegerField(choices=[(0, 'system'), (1, 'user'), (2, 'event'), (3, 'email'), (4, 'notification'), (5, 'other')], default=0, verbose_name='类型')),
                ('uuid', models.CharField(max_length=128, verbose_name='识别码')),
                ('title', models.CharField(blank=True, max_length=128, null=True, verbose_name='标题')),
                ('trigger_time', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True, verbose_name='时间')),
                ('describe', models.TextField(blank=True, null=True, verbose_name='描述')),
                ('read', models.BooleanField(default=False, verbose_name='Read')),
                ('from_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nffromuser', to=settings.AUTH_USER_MODEL, verbose_name='发送人员')),
                ('to_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nftouser', to=settings.AUTH_USER_MODEL, verbose_name='通知人员')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_time', models.DateTimeField(auto_now=True, verbose_name='收藏时间')),
